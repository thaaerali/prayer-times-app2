...
class NahjLetters {
    ...
    createDefaultIndex() {
        ...
        this.lettersIndex = [
            ...
            {
                id: 4,
                file: 'letters/letter-004.json',
                title: 'العهد إلى مالك الأشتر',
                subtitle: 'عهد للأشتر النخعي لما ولاه مصر',
                description: 'العهد الشهير للأشتر النخعي عند توليته مصر',
                recipient: 'مالك الأشتر النخعي',
                occasion: 'توليته على مصر',
                year: '37 هـ',
                category: 'الإدارة والولاية',
                page_start: 361,
                page_end: 368,
                ...
                total_sections: 32,
                has_content: false,
                keywords: ['الأشتر', 'مصر', 'الولاية', 'العدل', 'الحكم']
            }
        ];
